...
## 3. Validation
- [x] 3.1 Verify with a multi-temp profile (e.g., adaptive_v2.json: frames at [93,93,88,88]) that override preserves offsets
- [x] 3.2 Verify profile editor preserves offsets when changing global temp
- [x] 3.3 Verify uniform-temp profiles still work correctly (delta produces same result as absolute)
